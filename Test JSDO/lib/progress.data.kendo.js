        ...
        _convertDataTypes: function(data) {
            ...
            for (k = 0; k < transport._convertFields._dateFields.length; k += 1) {
                ...
                if (typeof(data[fieldName]) === "string") {
                    ...
                    if (transport._convertFields._datePattern.test(data[fieldName])) {
                        array = data[fieldName].split("-");
                        data[fieldName] = new Date(parseInt(array[0], 10), 
                                                    parseInt(array[1], 10) - 1, 
                                                    parseInt(array[2], 10));
                    }
                    else {
